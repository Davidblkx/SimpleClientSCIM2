...
namespace SimpleClientSCIM2.Schema
{
    ...
    public class User : Resource
    {
        ...
        {
            Name = new Name();
            Emails = new List<MultiValue>();
            PhoneNumbers = new List<MultiValue>();
            IMS = new List<MultiValue>();
            Photos = new List<MultiValue>();
            Groups = new List<MultiValue>();
            Entitlements = new List<object>();
            Roles = new List<MultiValue>();
            Certificates = new List<MultiValue>();
        ...
        /// just the full name as a single public string in the formatted
        ...
        /// </summary>
        [JsonProperty("emails")]
        public List<MultiValue> Emails { get; set; }
        ...
        public List<MultiValue> PhoneNumbers { get; set; }
        ...
        /// </summary>
        [JsonProperty("ims")]
        public List<MultiValue> IMS { get; set; }
        ...
        /// </summary>
        [JsonProperty("photos")]
        public List<MultiValue> Photos { get; set; }
        ...
        /// </summary>
        [JsonProperty("groups")]
        public List<MultiValue> Groups { get; set; }
        ...
        /// specified, although it is expected that a role value is a public string
        /// or label representing a collection of entitlements.This value
        /// has no canonical types.
        /// </summary>
        [JsonProperty("roles")]
        public List<MultiValue> Roles { get; set; }
        ...
        public List<MultiValue> Certificates { get; set; }
